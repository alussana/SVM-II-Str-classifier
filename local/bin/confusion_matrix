...
def ss_specific_predictions(real_dssp_dir, imputed_dssp_dir, idList, ss):
	real = []
	imputed = []
	with open(idList) as ids:
		for prot_id in ids:
...
if __name__ == '__main__':
	...
	for ss in ['H', 'E', '-']:
		real, imputed = ss_specific_predictions(real_dssp_dir, imputed_dssp_dir, idList, ss)
